...
EmpRace = gr.Dropdown(label="Race", choices=["White", "Black"," Amer Indian Aleut or Eskimo", "Asian or Pacific Islander", "Other"])
EmpHispanic = gr.Dropdown(label="Is Hispanic", choices=["All other", "Mexican-American", "Mexican (Puerto Rico Only)", "Central or South American", "Cuban", "Do not know", "Chicano"," Other Spanish", "Puerto Rican"])
EmpCommit = gr.Dropdown(label="Employment Commitment", choices=["Children or Armed Forces","Full-time schedules", "Not in labor force", "PT for non-econ reasons usually FT"," PT for econ reasons usually FT", "PT for econ reasons usually PT", "Unemployed full-time", "Unemployed part-time"])
